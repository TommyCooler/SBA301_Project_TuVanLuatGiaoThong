...
export default function PaymentSuccessPage() {
  ...
  const { completePayment, parsePaymentDataFromUrl, isLoading, error } =
    useMomoPayment();
              ...
              <div className="bg-blue-50 rounded-lg p-6 mb-6">
                ...
                <div className="space-y-3">
                  <div className="flex justify-between">
                    ...
                    <span className="font-medium">
                      {paymentResult.usagePackage.name}
                    </span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-gray-600">Giá:</span>
                    <span className="font-medium">
                      {paymentResult.usagePackage.price?.toLocaleString(
                        "vi-VN"
                      )}{" "}
                      VNĐ
                    </span>
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="font-medium">
                      {paymentResult.usagePackage.dailyLimit} lượt
                    </span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-gray-600">Thời hạn:</span>
                    <span className="font-medium">
                      {paymentResult.usagePackage.daysLimit} ngày
                    </span>
                  </div>
                </div>
              </div>
