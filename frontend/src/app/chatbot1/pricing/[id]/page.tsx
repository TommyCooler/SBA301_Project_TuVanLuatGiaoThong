...
import { FaCheckCircle, FaArrowLeft, FaShoppingCart, FaClock, FaUsers, FaStar } from "react-icons/fa";
...
export default function UsagePackageDetail() {
    ...
    const { initiatePayment, isLoading: paymentLoading, error: paymentError } = useMomoPayment();

    useEffect(() => {
        // console.log("package: ", usagePackage)
        if (params.id) {
                ...
                <section className="bg-gray-50 py-16">
                    <div className="max-w-4xl mx-auto px-6">
                        <div className="text-center py-12">
                            <h2 className="text-2xl font-bold text-gray-900 mb-4">Không tìm thấy gói</h2>
    ...
    const descriptions = packageData.description
        ? packageData.description.split('.').map(desc => desc.trim()).filter(desc => desc.length > 0)
                ...
                <div className="max-w-4xl mx-auto px-6">
                    ...
                    <div className="bg-white rounded-xl shadow-lg p-8 mb-8">
                        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between mb-6">
                            <div>
                                ...
                                <p className="text-gray-600 text-lg">Gói sử dụng AI chatbot hỗ trợ tìm kiếm thông tin luật giao thông</p>
                            </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                            ...
                            <div className="flex items-center gap-3 p-4 bg-green-50 rounded-lg">
                                ...
                                <div>
                                    <div className="font-semibold text-gray-900">{packageData.daysLimit}</div>
                        ...
                        {/* Features */}
                        <div className="mb-8">
                            <h3 className="text-xl font-semibold text-gray-900 mb-4">Tính năng bao gồm</h3>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                        ...
                        <div className="bg-white rounded-xl shadow-lg p-6">
                            <h3 className="text-xl font-semibold text-gray-900 mb-4">Bao gồm những gì?</h3>
                            <ul className="space-y-3">
                                <li className="flex items-start gap-3">
                                    <FaCheckCircle className="text-green-500 mt-1 flex-shrink-0" />
                                    <span className="text-gray-700">Truy cập không giới hạn AI chatbot</span>
                                </li>
                                <li className="flex items-start gap-3">
                                    <FaCheckCircle className="text-green-500 mt-1 flex-shrink-0" />
                                    <span className="text-gray-700">Hỗ trợ tìm kiếm thông tin luật giao thông</span>
                                </li>
                                <li className="flex items-start gap-3">
                                    <FaCheckCircle className="text-green-500 mt-1 flex-shrink-0" />
                        ...
                        <div className="bg-white rounded-xl shadow-lg p-6">
                            ...
                            <div className="space-y-4">
                                <div>
                                    <h4 className="font-semibold text-gray-900 mb-2">Có thể hủy gói bất cứ lúc nào không?</h4>
                                    <p className="text-gray-600 text-sm">Có, bạn có thể hủy gói bất cứ lúc nào mà không bị phạt phí.</p>
                                </div>
                                <div>
                                    <h4 className="font-semibold text-gray-900 mb-2">Gói có hiệu lực ngay lập tức không?</h4>
                                    <p className="text-gray-600 text-sm">Có, gói sẽ có hiệu lực ngay sau khi thanh toán thành công.</p>
                                </div>
                                <div>
                                    <h4 className="font-semibold text-gray-900 mb-2">Có thể nâng cấp gói không?</h4>
                                    <p className="text-gray-600 text-sm">Có, bạn có thể nâng cấp gói bất cứ lúc nào và chỉ trả tiền chênh lệch.</p>
                                </div>
                            </div>
                        </div>
                    </div>
